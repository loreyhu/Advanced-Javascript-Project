...
async function getData(){
    ...
    try {
        const response = await axios.get(`https://api.teleport.org/api/urban_areas/slug:${input.toLowerCase()}/scores/`)
...
async function createElements(e){
    ...
    let score = Math.floor(result.data.teleport_city_score)
